...
export default function App(){
    return(<AuthProvider><BrowserRouter><Routes>
        ...
        <Route path="/admin/modify-medicine-stock" element={<ProtectedRoute adminOnly><ModifyMedicineStock/></ProtectedRoute>}/>
        <Route path="/admin/transactions" element={<ProtectedRoute adminOnly><ApproveTransactions/></ProtectedRoute>}/>
        <Route path="/admin/medicine-stock" element={<ProtectedRoute adminOnly><AdminMedicineStock/></ProtectedRoute>}/>
        ...
        <Route path="/admin/medicine-stock-adjustments" element={<ProtectedRoute adminOnly><ViewMedicineStockAdjustments/></ProtectedRoute>}/>
