...
class TransactionControllerTest {
    ...
    class UserGetMy {
        ...
        @Test
        @WithMockUser(username = "john.doe", roles = "USER")
        @DisplayName("response includes medicineStockType so the user can tell regular vs admin stock dispatches apart")
    ...
    class DeleteMine {
        ...
        void deleteMine_notPending_409() throws Exception {
            doThrow(new com.pharma.medicinestock.exception.InvalidStateTransitionException("APPROVED", "delete"))
