...
import com.pharma.medicinestock.security.JwtAuthenticationFilter;
    ...
    @Bean public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http.csrf(AbstractHttpConfigurer::disable)
            ...
            .authorizeHttpRequests(a->a
                ...
                .requestMatchers(HttpMethod.GET,  "/api/medicine-stock/available").hasRole("USER")
                ...
                .requestMatchers("/api/medicine-stock/**").hasRole("ADMIN")
