...
public class MedicineStockResponse {
    ...
    public Double getConcentrationMgPerMl(){return concentrationMgPerMl;} public void setConcentrationMgPerMl(Double c){this.concentrationMgPerMl=c;}
    ...
    public String getMedicineStockType(){return medicineStockType;} public void setMedicineStockType(String t){this.medicineStockType=t;}
}
