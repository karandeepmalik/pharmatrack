...
public class AdjustMedicineStockRequest {
    @NotNull private Long userId;
    @NotNull private Long medicineId;
    @NotNull @DecimalMin("0.1") private BigDecimal quantity;
    ...
    private String medicineStockType = "REGULAR_MEDICINE_STOCK";
    ...
    public String getMedicineStockType() { return medicineStockType != null ? medicineStockType : "REGULAR_MEDICINE_STOCK"; }
    public void setMedicineStockType(String medicineStockType) { this.medicineStockType = medicineStockType; }
