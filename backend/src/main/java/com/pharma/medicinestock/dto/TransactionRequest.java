...
/**
 * DTO for submitting a medicine stock adjustment (dispatch) request.
 *
...
public class TransactionRequest {
    ...
    /**
     * The medicine stock bucket to deduct from: REGULAR_MEDICINE_STOCK or ADMIN_MEDICINE_STOCK.
    ...
    public String getMedicineStockType() { return medicineStockType; }
