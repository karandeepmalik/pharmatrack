...
public class InventoryResponse {
    private Long id,userId,medicineId,pharmaId; private String username,medicineName,medicineType,pharmaName; private Double specification; private Integer quantity;
